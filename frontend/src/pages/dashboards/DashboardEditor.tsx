...
import { Button, Space, Input, Drawer, Card, Form, Select, InputNumber, message, Modal, Row, Col, Tag, Typography } from 'antd';
...
const DashboardEditor: React.FC = () => {
  ...
  const renderWidgetPlaceholder = (widget: any) => (
    <Card
      ...
      extra={
        <Space>
          <Button size="small" icon={<SettingOutlined />} onClick={() => openConfig(widget.id)} />
          <Button size="small" danger icon={<DeleteOutlined />} onClick={() => handleDeleteWidget(widget.id)} />
        </Space>
      }
    >
