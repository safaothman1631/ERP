...
const CreditNotes: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onCancel={() => setModalOpen(false)} title={t('new_credit_note')} width={900} footer={null} destroyOnHidden>
      ...
      <Modal open={!!applyModal} onCancel={() => setApplyModal(null)} title={t('applyToInvoice')} width={700} footer={null} destroyOnHidden>
        <Tabs items={[
          {
            key: 'apply',
              ...
              <Table
                ...
                columns={[
                  ...
                  { title: t('date'), dataIndex: 'date', key: 'date', render: (d: string) => d?.substring(0, 10) },
                  {
                    title: t('actions'), key: 'actions',
                    render: (_: any, r: any) => (
                      <Button size="small" danger icon={<DeleteOutlined />} onClick={() => handleRemoveApplication(r.id)} />
                    ),
                  },
                ]}
                rowKey="id"
