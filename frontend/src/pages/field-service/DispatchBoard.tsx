...
import { Card, Table, Tag, Button, Drawer, List, Select, Space, DatePicker } from 'antd';
                ...
                actions={[
                  assigningOrderId === order.id ? (
                    <Space>
                      ...
                      <Button type="primary" size="small" onClick={handleAssign}>
                        {t('assign')}
                      </Button>
                      <Button size="small" onClick={() => setAssigningOrderId(null)}>
                        {t('cancel')}
                      </Button>
                    </Space>
                  ) : (
