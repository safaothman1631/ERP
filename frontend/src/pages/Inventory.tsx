...
import { Tabs, Table, Button, Tag, Card, Statistic, Row, Col, Modal, Form, Input, InputNumber, Select, Space } from 'antd';
...
const InventoryOverview: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Table dataSource={valuation} columns={[
...
const Adjustments: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onCancel={() => setModalOpen(false)} title={t('new_adjustment')} footer={null} destroyOnHidden>
...
const ItemGroups: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Table dataSource={groups} columns={[
        { title: t('name'), dataIndex: 'name', key: 'name' },
        { title: t('description'), dataIndex: 'description', key: 'description' },
      ]} rowKey="id" loading={loading} />
      <Modal open={modalOpen} onCancel={() => setModalOpen(false)} title={t('new_group')} footer={null} destroyOnHidden>
        <Form form={form} layout="vertical" onFinish={handleSave}>
