...
import { Card, Tabs, Table, Button, Modal, Form, Input, InputNumber, Select, DatePicker, Empty, Space, Tag, Popconfirm, Alert } from 'antd';
    ...
    cols.push({
      ...
      render: (_: any, row: any) => (
        <Space size={2}>
          ...
          <Popconfirm title={t('hub_confirm_delete')} onConfirm={() => handleDelete(row.id)} okText={t('hub_save')} cancelText={t('hub_cancel')}>
  ...
  return (
    <>
      ...
      <Modal
        ...
        open={open}
        onOk={handleSubmit}
        onCancel={() => { setOpen(false); form.resetFields(); setEditingId(null); }}
        confirmLoading={submitting}
        okText={t('hub_save')}
        cancelText={t('hub_cancel')}
        width={600}
        destroyOnHidden
      >
