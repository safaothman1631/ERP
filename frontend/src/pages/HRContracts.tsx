...
import { Card, Table, Button, Modal, Form, Select, DatePicker, Input, InputNumber, Space, Popconfirm, Tag, message } from 'antd';
...
export default function HRContracts() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <Modal open={open} onOk={save} onCancel={() => setOpen(false)} title={t('new_contract')} destroyOnHidden>
