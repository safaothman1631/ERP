...
import { Card, Descriptions, Table, Button, Space, Tag, Modal, Form, DatePicker, InputNumber, Empty, Spin, Input } from 'antd';
  ...
  return (
    <>
      ...
      <Card title={t('assets.depreciation_history')} style={{ marginTop: 16 }}>
        <Table columns={historyColumns} dataSource={history} rowKey="id" pagination={false} locale={{ emptyText: <Empty description={t('assets.no_depreciation_yet')} /> }} />
      </Card>
