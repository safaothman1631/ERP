...
import { Table, Button, Tag, Modal, Form, Input, InputNumber, Select, Space, DatePicker, Popconfirm, Row, Col, Empty } from 'antd';
...
const FixedAssets: React.FC = () => {
  ...
  return (
    <>
      ...
      <Table columns={columns} dataSource={data} rowKey="id" loading={loading} pagination={{ pageSize: 20 }} locale={{ emptyText: <Empty description={t('empty_assets')} /> }} />
      <Modal
