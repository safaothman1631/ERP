...
import { Card, Table, Tag, Button, Modal, Form, Input, Select, Space, Typography } from 'antd';
        ...
        <Table
          ...
          columns={[
            ...
            )},
            {
              ...
              render: (_: any, r: any) => (
                <Space>
                  <Button size="small" icon={<EditOutlined />} onClick={() => openEdit(r)} disabled={r.is_system} />
                  <Button size="small" danger icon={<DeleteOutlined />} onClick={() => onDelete(r.id)} disabled={r.is_system} />
                </Space>
              ),
            },
          ]}
