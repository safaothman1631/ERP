...
import { Table, Button, Space, Input, Drawer, Form, Select, InputNumber, Typography, Card } from 'antd';
...
const BOQEditor: React.FC = () => {
  ...
  const columns: TableColumnsType<BOQItem> = [
  ...
  return (
    <>
      ...
      <Drawer title={t('construction.add_boq_item')} open={drawer} onClose={() => setDrawer(false)} width={500}>
