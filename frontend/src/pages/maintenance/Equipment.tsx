...
import { Table, Button, Tag, Modal, Form, Input, InputNumber, Select, Space, DatePicker, Popconfirm, Row, Col } from 'antd';
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: unknown, record: Equipment) => (
        <Space size="small">
          <Button size="small" icon={<EyeOutlined />} onClick={() => navigate(`/maintenance/equipment/${record.id}`)}>
            {t('view')}
          </Button>
