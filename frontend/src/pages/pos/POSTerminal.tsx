...
import {
  Layout, Card, Button, Input, Row, Col, Space, Typography, Tag, Modal, Form,
  InputNumber, Tabs, Divider, Badge, Spin, Empty, Select
} from 'antd';
import {
          ...
          <div style={{ padding: 16, height: '100%', display: 'flex', flexDirection: 'column' }}>
            ...
            <Card size="small" style={{ marginBottom: 16 }}>
              <Space style={{ width: '100%', justifyContent: 'space-between' }}>
                ...
                <Button size="small" onClick={() => setCustomerSelectorVisible(true)}>
