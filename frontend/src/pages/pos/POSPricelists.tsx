...
import { Table, Button, Space, Modal, Form, Input, Select, InputNumber, Card, Tag, DatePicker } from 'antd';
                ...
                <>
                  {fields.map((field, index) => (
                    <Card
                      ...
                      extra={<Button icon={<MinusCircleOutlined />} danger size="small" onClick={() => remove(field.name)} />}
