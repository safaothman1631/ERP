...
import { Button, Tag, Form, DatePicker, Input, Space } from 'antd';
...
const TaxReturns: React.FC = () => {
 ...
 <Space>
 {r.status === 'draft' && (
 <Button icon={<SendOutlined />} onClick={() => handleFile(r.id)}>
 {t('file')}
 </Button>
 )}
 </Space>
 ...
 <FormDialog open={modalOpen} onClose={() => setModalOpen(false)} title={t('taxReturns')} hideFooter>
