...
import { Button, Space, Modal, Form, Input, Select, Tree, Table, Popconfirm, Card, Empty, Typography } from 'antd';
    ...
    return locs.map(loc => ({
      ...
      title: (
        <Space>
          ...
          <Button size="small" type="text" icon={<EditOutlined />} onClick={() => openEdit(loc)} />
