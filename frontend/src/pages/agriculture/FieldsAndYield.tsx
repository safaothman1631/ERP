...
import { Tabs, Table, Button, Space, Input, Drawer, Form, Select, InputNumber, Card } from 'antd';
...
const FieldsAndYield: React.FC = () => {
  ...
  const fieldColumns: TableColumnsType<Field> = [
  ...
  return (
    <>
      ...
      <Drawer title={t('agriculture.add_field')} open={drawer} onClose={() => setDrawer(false)} width={500}>
