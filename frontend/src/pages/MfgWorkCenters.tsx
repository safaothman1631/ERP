...
import { Card, Table, Button, Modal, Form, Input, InputNumber, Switch, Space, Popconfirm, message } from 'antd';
...
export default function MfgWorkCenters() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <Modal open={open} onOk={save} onCancel={() => setOpen(false)} title={editing ? t('edit') : t('new_work_center')} destroyOnHidden>
