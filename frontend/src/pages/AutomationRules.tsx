...
import { Button, Space, Form, Input, Select, Switch, Tag, message, Card, Alert, Modal } from 'antd';
...
const AutomationRules: React.FC = () => {
 ...
 />
 <Button icon={<PlayCircleOutlined />} type="primary" onClick={() => handleRunNow(record.id)} title={t('automation.run_now')} />
 ...
 <ResponsiveTableAdapter dataSource={rules} columns={columns} loading={loading} rowKey="id" />
 </Card>
