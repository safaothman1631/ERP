...
import { Card, Tabs, Table, Button, Modal, Form, Input, InputNumber, Switch, Select, message, Popconfirm, Space } from 'antd';
...
export default function HelpdeskSettings() {
  ...
  const teamCols: TableProps<Team>['columns'] = [
    ...
    { title: t('description'), dataIndex: 'description', key: 'description' },
    {
      ...
      render: (_, rec) => (
        <Space>
          <Button size="small" icon={<EditOutlined />} onClick={() => openModal('teams', rec)} />
  ...
  const slaCols: TableProps<SLAPolicy>['columns'] = [
    ...
    { title: t('helpdesk.resolution_minutes'), dataIndex: 'resolution_minutes', key: 'resolution_minutes' },
    {
      ...
      render: (_, rec) => (
        <Space>
          <Button size="small" icon={<EditOutlined />} onClick={() => openModal('sla-policies', rec)} />
  ...
  const tabItems = [
    {
      ...
      children: (
        <div>
          ...
          <Table dataSource={teams} columns={teamCols} rowKey="id" loading={loading} />
        </div>
      ),
    },
    {
      ...
      children: (
        <div>
          ...
          <Table dataSource={categories} columns={categoryCols} rowKey="id" loading={loading} />
        </div>
      ),
    },
    {
      ...
      children: (
        <div>
          ...
          <Table dataSource={tags} columns={tagCols} rowKey="id" loading={loading} />
        </div>
      ),
    },
    {
      ...
      children: (
        <div>
          ...
          <Table dataSource={slaPolicies} columns={slaCols} rowKey="id" loading={loading} />
        </div>
      ),
    },
  ];
