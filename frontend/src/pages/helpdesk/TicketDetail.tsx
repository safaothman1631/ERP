...
import { Card, Tabs, Button, Space, Modal, Form, Input, Select, message, List, Tag, Spin } from 'antd';
...
export default function TicketDetail() {
  ...
  return (
    <div style={{ padding: space.lg }}>
      ...
      <Modal title={t('helpdesk.add_reply')} open={replyOpen} onOk={onReply} onCancel={() => setReplyOpen(false)}>
      ...
      <Modal title={t('helpdesk.assign')} open={assignOpen} onOk={onAssign} onCancel={() => setAssignOpen(false)}>
