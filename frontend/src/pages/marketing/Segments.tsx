...
import { Table, Button, Space, Modal, Form, Input, Select, Card, Popconfirm, Tag } from 'antd';
...
const Segments: React.FC = () => {
  ...
  const columns: TableColumnsType<any> = [
    ...
    },
    {
      ...
      render: (_: any, rec: any) => (
        <Space size="small">
          <Button size="small" icon={<EyeOutlined />} onClick={() => handlePreview(rec.id)}>
            {t('marketing.preview')}
          </Button>
  ...
  const previewColumns: TableColumnsType<any> = [
    { title: t('marketing.name'), dataIndex: 'name', key: 'name' },
