...
import { Table, Button, Space, Modal, Form, Input, Select, Drawer, Statistic, Row, Col, Card, Popconfirm } from 'antd';
    ...
    },
    {
      ...
      render: (_: any, rec: any) => (
        <Space size="small">
          ...
          <Button size="small" icon={<EyeOutlined />} onClick={() => handleViewStats(rec.id)}>
            {t('marketing.stats')}
          </Button>
          <Button size="small" icon={<CopyOutlined />} onClick={() => handleClone(rec)} />
