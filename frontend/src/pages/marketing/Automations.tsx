...
import { Table, Button, Space, Modal, Form, Input, Select, Steps, List, Popconfirm, Switch, Tag } from 'antd';
        ...
        {currentStep === 1 && (
          <div>
            <Space style={{ marginBottom: 16 }}>
              <Button size="small" onClick={() => addStep('email')}>
                + {t('marketing.step_email')}
              </Button>
              <Button size="small" onClick={() => addStep('sms')}>
                + {t('marketing.step_sms')}
              </Button>
              <Button size="small" onClick={() => addStep('wait')}>
                + {t('marketing.step_wait')}
              </Button>
              <Button size="small" onClick={() => addStep('tag')}>
            ...
            <List
              ...
              renderItem={(step: any, index: number) => (
                <List.Item
                  actions={[
                    <Button size="small" icon={<UpOutlined />} onClick={() => moveStep(index, 'up')} />,
                    <Button size="small" icon={<DownOutlined />} onClick={() => moveStep(index, 'down')} />,
