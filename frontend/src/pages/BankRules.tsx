...
import { Table, Button, Tag, Modal, Form, Input, Select, Space, Popconfirm, Empty, Typography } from 'antd';
...
const BankRules: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader
        title={t('bankRules')}
        subtitle={t('bank_rules_subtitle', 'یاسا خۆکاراکانی بانک')}
        extra={
      ...
      <Modal
        ...
        title={editingId ? t('edit') : t('bankRules')}
        footer={null}
        destroyOnHidden
        width={600}
      >
