...
import { Table, Tag, Card, Drawer, Button, Space } from 'antd';
  ...
  return (
    <div>
      ...
      <Card style={{ marginTop: space.md }}>
        <Table dataSource={runs} columns={columns} loading={loading} rowKey="id" />
      </Card>
            ...
            {selectedRun.trace && (
              <div style={{ marginTop: space.md }}>
                ...
                {selectedRun.trace.map((step: any, idx: number) => (
                  <Card key={idx} size="small" style={{ marginBottom: space.sm }}>
