...
import { Table, Button, Space, Drawer, Form, Input, Select, Switch, Tag, Popconfirm } from 'antd';
  ...
  return (
    <div>
      ...
      {fields.length === 0 && !loading ? (
        <EmptyState
          title={t('studio.no_custom_fields', 'بێ خانەی تایبەت')}
          description={t('studio.no_custom_fields_desc', 'هیچ خانەیەکی تایبەت زیاد نەکراوە')}
          actionLabel={t('studio.add_first_field', 'یەکەم خانە زیاد بکە')}
          onAction={() => {
            setEditId(null);
            setFieldType('text');
            form.resetFields();
