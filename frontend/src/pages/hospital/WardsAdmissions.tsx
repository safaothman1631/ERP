...
import { Tabs, Table, Button, Space, Form, Modal, Input, Select, message, Popconfirm, Card, Row, Col, Statistic } from 'antd';
        ...
        items={[
          {
            ...
            children: (
              <>
                ...
                <Table dataSource={wards} columns={wardColumns} rowKey="id" loading={loading} />
              </>
            ),
          },
          {
            ...
            children: (
              <>
                ...
                <Table dataSource={admissions} columns={admissionColumns} rowKey="id" loading={loading} />
              </>
            ),
          },
        ]}
