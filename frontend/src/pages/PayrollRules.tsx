...
import { Card, Table, Button, Modal, Form, Input, InputNumber, Select, Space, Popconfirm, Tag, message, Switch } from 'antd';
...
export default function PayrollRules() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <Card><Table rowKey="id" dataSource={list} columns={cols} pagination={false} /></Card>

      <Modal open={open} onOk={save} onCancel={() => setOpen(false)} title={editing ? t('edit_rule') : t('new_rule')} destroyOnHidden>
