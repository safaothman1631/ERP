...
import { Table, Button, Modal, Form, Input, Select, Space, Switch, InputNumber, Card, Tag, Popconfirm } from 'antd';
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
          ...
          <Card size="small" title={t('approvals.condition_label')} style={{ marginBottom: 16 }}>
            ...
            {(fields, { add, remove }) => (
              <>
                {fields.map((field, index) => (
                  <Card key={field.key} size="small" title={`${t('approvals.step')} ${index + 1}`} style={{ marginBottom: 8 }}>
