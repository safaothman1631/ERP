...
import { Table, Button, Modal, Form, Input, Select, Space, Tag, message, Popconfirm, Card, Row, Col } from 'antd';
...
export default function CRMActivities() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <Table rowKey="id" loading={loading} dataSource={items} columns={visibleColumns} pagination={{ pageSize: 20 }} />

      <Modal title={t('new_activity')} open={open} onCancel={() => setOpen(false)} onOk={onCreate} destroyOnHidden>
