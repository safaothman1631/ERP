...
import { Card, Button, Modal, Form, Input, Select, DatePicker, InputNumber, Drawer, Tag, Space, Divider, message as antMessage } from 'antd';
          ...
          <div style={{ overflowX: 'auto' }}>
            ...
            {data.milestones.map(ms => (
              <div key={ms.id} style={{ marginBottom: space.xs, display: 'flex', alignItems: 'center', gap: space.sm }}>
                ...
                {!ms.done && (
                  <Button size="small" type="link" onClick={() => completeMilestone(ms.id)}>
                    {t('mark_complete')}
                  </Button>
                )}
              </div>
