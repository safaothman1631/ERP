...
import { 
  Card, Row, Col, Form, Select, Button, Table, Space, 
  Modal, Input, message, Tag, Divider 
} from 'antd';
import { 
  ...
  return (
    <div>
      <Card title={t('custom_reports.builder_title')}>
        <Row gutter={24}>
          <Col span={8}>
            <Card size="small" title={t('custom_reports.configuration')}>
          ...
          <Col span={16}>
            <Card size="small" title={t('custom_reports.results')}>
      ...
      <Modal
        ...
        okText={t('custom_reports.save')}
        cancelText={t('custom_reports.cancel')}
      >
