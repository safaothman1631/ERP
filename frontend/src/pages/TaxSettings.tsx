...
import { Tabs, Table, Button, Modal, Form, Input, InputNumber, Space, Popconfirm } from 'antd';
...
const TaxRates: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onCancel={() => setModalOpen(false)} title={t('new_tax_rate')} footer={null} destroyOnHidden>
...
const TaxGroups: React.FC = () => {
  ...
  return (
    <div>
      ...
      <Modal open={modalOpen} onCancel={() => setModalOpen(false)} title={t('new_tax_group')} footer={null} destroyOnHidden>
        <Form form={form} layout="vertical" onFinish={handleSave}>
