...
import { Table, Button, Space, Modal, Form, Input, Select, Tag, message, Card, InputNumber, DatePicker } from 'antd';
      ...
      render: (_: any, record: any) => (
        <Space>
          {record.status !== 'completed' && (
            <Button icon={<PlayCircleOutlined />} size="small" type="primary" onClick={() => handleExecute(record.id)} title={t('maintenance.execute')} />
          )}
  ...
  return (
    <div>
      ...
      <Card style={{ marginTop: space.md }}>
        <Table dataSource={requests} columns={columns} loading={loading} rowKey="id" />
      </Card>
