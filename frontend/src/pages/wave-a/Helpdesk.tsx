...
const Helpdesk: React.FC = () => {
 ...
 <Button icon={<CheckOutlined />} type="primary" onClick={() => handleStatusChange(record.id, 'resolved')} />
 )}
 ...
 <ResponsiveTableAdapter dataSource={tickets} columns={columns} loading={loading} rowKey="id" />
 </Card>
