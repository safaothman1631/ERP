...
const Repairs: React.FC = () => {
 ...
 <Button icon={<ToolOutlined />} type="primary" onClick={() => handleStatusChange(record.id, 'repairing')} title={t('repairs.start_repair')} />
 )}
 {record.status === 'repairing' && (
 <Button type="primary" onClick={() => handleStatusChange(record.id, 'ready')} title={t('repairs.mark_ready')}>{t('repairs.ready')}</Button>
 )}
