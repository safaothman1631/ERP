...
import { Drawer, Typography, Tag, Divider, Alert, Space } from 'antd';
  ...
  return (
    ...
    >
      ...
      {content.shortcuts && content.shortcuts.length > 0 && (
        <>
          <Divider />
          <Title level={5}>{t('help_shortcuts', 'کورت‌ڕێگاکانی کیبۆرد')}</Title>
      ...
      {content.related && content.related.length > 0 && (
        <>
          <Divider />
          <Title level={5}>{t('help_related', 'پەیجی پەیوەست')}</Title>
          <Space wrap>
