...
import { Select, Button, Modal, Form, Input, Popconfirm, Space, message } from 'antd';
  ...
  return (
    <>
        ...
        {selectedFilterId && (
          <>
            ...
            <Popconfirm
              ...
              okText={t('saved_filters.yes')}
              cancelText={t('saved_filters.no')}
            >
      ...
      <Modal
        ...
        okText={t('saved_filters.save')}
        cancelText={t('saved_filters.cancel')}
      >
