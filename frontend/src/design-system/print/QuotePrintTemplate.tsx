...
import type { PrintTemplateProps, QuoteDocument } from './types';

/**
 * QuotePrintTemplate — A4 print template for Sales Quotes / Quotations.
 ...
 */
export const QuotePrintTemplate: React.FC<PrintTemplateProps> = ({
  document,
  company,
  isRTL,
  currency,
}) => {
  const doc = document as QuoteDocument;
