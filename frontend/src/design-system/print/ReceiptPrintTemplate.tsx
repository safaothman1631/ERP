...
import type { PrintTemplateProps, ReceiptDocument } from './types';

/**
 * ReceiptPrintTemplate — A4 print template for Payment Receipts.
 ...
 */
export const ReceiptPrintTemplate: React.FC<PrintTemplateProps> = ({
  document,
  company,
  isRTL,
  currency,
}) => {
  const doc = document as ReceiptDocument;
