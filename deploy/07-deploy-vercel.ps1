...
# Filter Vercel CLI banner/noise lines from output. Vercel CLI on Windows
# emits "Vercel CLI x.y.z" and sometimes node.exe banner lines to stderr
# that pollute captured output. Strip them.
